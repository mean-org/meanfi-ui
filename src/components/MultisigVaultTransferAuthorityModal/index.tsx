...
export const MultisigVaultTransferAuthorityModal = (props: {
  ...
  const { transactionStatus, getTokenByMintAddress, setTransactionStatus } =
  ...
  const [
    ...
    setDestinationAddressDisclaimerAccepted,
  ] = useState(false);
      ...
      <div className="transaction-list-row no-pointer">
        ...
        <div className="description-cell">
          <div className="title text-truncate">
            {token
              ? token.symbol
              : `${CUSTOM_TOKEN_NAME} [${shortenAddress(item.address, 6)}]`}
          </div>
          <div className="subtitle text-truncate">
            {shortenAddress(item.publicAddress, 8)}
          </div>
        </div>
    ...
    <Modal
      ...
      title={
        <div className="modal-title">
          {t('multisig.transfer-authority.modal-title')}
        </div>
      }
      maskClosable={false}
      footer={null}
        ...
        {transactionStatus.currentOperation === TransactionStatus.Iddle ? (
          <>
            ...
            {props.selectedVault && (
              <div className="mb-3">
                <div className="form-label">
                  {t('multisig.transfer-authority.selected-asset-label')}
                </div>
              ...
              <div className="well">
                ...
                selectedAuthority ===
                  ...
                  <span className="form-field-error">
                    {t(
                      'multisig.transfer-authority.multisig-already-owns-the-asset',
                    )}
                  </span>
                ) : selectedAuthority && !isValidAddress(selectedAuthority) ? (
                  <span className="form-field-error">
            ...
            <div className="mb-3 ml-1">
              ...
              >
                {t(
                  'multisig.transfer-authority.asset-auth-destination-address-disclaimer',
                )}
              </Checkbox>
            </div>
            ...
            {!isError(transactionStatus.currentOperation) && (
              <div className="col-12 p-0 mt-3">
                <Button
                  ...
                  size="large"
                  disabled={
                    !isValidForm() || !destinationAddressDisclaimerAccepted
                  }
                  onClick={() => {
                    if (
          ...
          <>
            <div className="transaction-progress">
              ...
              <h4 className="font-bold">
                {t('multisig.transfer-authority.success-message')}
              </h4>
            </div>
          </>
        ) : (
