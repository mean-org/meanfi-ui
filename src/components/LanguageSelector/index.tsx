...
interface Props {
  isVisible: boolean;
  handleClose: () => void;
  handleOk: (code: string) => void;
}

export const LanguageSelector = ({ isVisible, handleOk, handleClose }: Props) => {
          ...
          {LANGUAGES?.map(item => {
            return (
              <div
                ...
                onKeyDown={() => changeLanguageByCode(item.code)}
