...
export const MultisigCreateModal = (props: {
  ...
  }, [publicKey, props.isVisible, props.multisigAccounts]);
    ...
    <Modal
      ...
      title={
        <div className="modal-title">
          {t('multisig.create-multisig.modal-title')}
        </div>
      }
      maskClosable={false}
      footer={null}
        ...
        {transactionStatus.currentOperation === TransactionStatus.Iddle ? (
          <>
            ...
            {multisigOwners.length >= 1 &&
              multisigOwners.length === +multisigThreshold &&
              multisigOwners[+multisigThreshold - 1].address !== '' && (
                <span className="warning-message icon-label">
                  <IconWarning className="mean-svg-icons" />
                  {t(
                    'multisig.create-multisig.multisig-participants-warning-message',
                  )}
                </span>
              )}
            {/* Fee info */}
          ...
          <>
            <div className="transaction-progress">
              ...
              <h4 className="font-bold">
                {t('multisig.create-multisig.success-message')}
              </h4>
            </div>
          </>
        ) : (
