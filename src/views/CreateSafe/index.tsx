    ...
    (param: any) => {
      ...
      if (item.operationType === OperationType.CreateMultisig) {
        ...
        openNotification({
          ...
          description:
            'Your SuperSafe account was successfully created and it is ready to be used. Check it out under your account.',
          duration: 12,
          type: 'success',
        });
      }
    ...
    (param: any) => {
      ...
      if (item.operationType === OperationType.CreateMultisig) {
        ...
        openNotification({
          ...
          description:
            'The transaction to create a SuperSafe account was not confirmed within 40 seconds. Solana may be congested right now. This page needs to be reloaded to verify the contract was successfully created.',
          duration: 12,
          type: 'info',
        });
      }
    ...
    if (wallet && publicKey && data) {
      ...
      if (created && !transactionCancelled) {
        ...
        if (sign.encodedTransaction) {
          ...
          const sent = await sendTx('Create Safe', connection, encodedTx);
