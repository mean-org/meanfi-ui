...
export const BPF_LOADER_UPGRADEABLE_PID = new PublicKey('BPFLoaderUpgradeab1e11111111111111111111111');
...
export const MEAN_MULTISIG = new PublicKey('FF7U7Vj1PpBkTPau7frwLLrUHrjkxTQLsH7U5K3T3B3j');
