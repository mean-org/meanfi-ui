...
export const IconMoneyStreaming = (props: {
  ...
  return (
    ...
    >
      ...
      <path
        fill="#B7CAC4"
        d="M412.6,177.8L250.4,96.7l-160,81.1c0,2.2,0,15.6,0,17.7l162.2,86.7l160-86.7
      ...
      <g>
        <path
          fill="#71AD71"
          d="M287.4,167.2c0,7.5-8.5,12.9-9,12.2c-6.4-7.4-17.3-12.9-28.3-12.9c-11.2,0-18.1,5-18.1,12.6
      ...
      <path
        fill="#EDEDED"
        d="M90.4,203.3v153.1c0,8,6.5,14.4,14.4,14.4h293.3c8,0,14.4-6.5,14.4-14.4l-0.3-153.3l-159.8,87.7
        L90.4,203.3"
      />
      <g>
        <path
