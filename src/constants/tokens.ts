...
export const MEAN_TOKEN_LIST: TokenInfo[] = [
  ...
  // Testnet tokens
  {
    ...
    decimals: 9,
    logoURI:
      'https://3txtza3bmunfw5ckgetu7qtgobudm6ii5hyyid7vrprmzykzhfmq.arweave.net/3O88g2FlGlt0SjEnT8JmcGg2eQjp8YQP9YvizOFZOVk?ext=png',
    tags: [],
  },
  {
    chainId: 102,
  ...
  },
  {
    ...
    extensions: {},
    logoURI:
      'https://cdn.jsdelivr.net/gh/trustwallet/assets@master/blockchains/ethereum/assets/0xEB4C2781e4ebA804CE9a9803C67d0893436bB27D/logo.png',
    name: 'Test RenBTC',
    symbol: 'renBTC',
    tags: ['saber-mkt-btc'],
  },
