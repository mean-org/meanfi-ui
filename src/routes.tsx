                  ...
                  <AppStateProvider>
                    <AppLayout>
                      <Routes>
                        ...
                        />
                        <Route
                          path="/accounts/assets/:asset"
                          element={<AccountsView />}
                        />
                        <Route
                          path="/accounts/streaming"
                          element={<AccountsView />}
                        />
                        <Route
                          path="/accounts/streaming/:streamingTab"
                          element={<AccountsView />}
                        />
                        <Route
                          path="/accounts/streaming/:streamingTab/:streamingItemId"
                          element={<AccountsView />}
                        />
                        <Route
                          path="/accounts/super-safe"
                          element={<AccountsView />}
                        />
                        <Route
                          path="/accounts/super-safe/proposals/:id"
                          element={<AccountsView />}
                        />
                        <Route
                          path="/accounts/super-safe/programs/:id"
                          element={<AccountsView />}
                        />
                        {/* Vesting routes */}
