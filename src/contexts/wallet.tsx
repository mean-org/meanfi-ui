...
const isSolflareExtension = () => {
  return !!(window as any).solflare?.isSolflare;
}

export const WALLET_PROVIDERS = [
  {
    name: isSolflareExtension() ? WalletName.Solflare : WalletName.SolflareWeb,
    ...
    adapter: isSolflareExtension() ? SolflareWalletAdapter : SolletWalletAdapter,
    adapterParams: isSolflareExtension() ? undefined : { provider: 'https://solflare.com/access-wallet' },
    hideOnDesktop: false,
    hideOnMobile: false
  },
  // {
  ...
  //   adapterParams: { provider: 'https://solflare.com/access-wallet' },
  //   hideOnDesktop: false,
  //   hideOnMobile: false
  // },
  {
